<div class="container-fluid">
	...
	<%= _.template($('#input_constructor').html())({
		id: "avatar",
		description: tr("avatar"),
		default_selector: "string",
		disable_int: true,
		value_string: "",
		help: {
			description: tr("Base64 data of the avatar.")
		}
	}) %>
    <%= _.template($('#block_start').html())({
        ...
        <%= _.template($('#input_constructor').html())({
			...
			value_number: "",
			help: {
				description: tr("Selection size. Minimum value - 16."),
			}
		}) %>
...
<div class="tooltipinternal">
	<div class="tr tooltip-paragraph-first-fold">Upload avatar for a user.</div>
</div>

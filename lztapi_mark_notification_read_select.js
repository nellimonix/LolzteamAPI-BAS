var notification_id = GetInputConstructorValue('notification_id', loader)
...
try {
	var code =
		...
		_.template($('#lztapi_mark_notification_read_code').html())({
			notification_id: notification_id['updated'],

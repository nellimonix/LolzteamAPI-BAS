<div class="container-fluid">
	<%= _.template($('#block_start').html())({
		...
		<%= _.template($('#input_constructor').html())({
			id: "parent",
			description: tr("parent"),
			default_selector: "int",
			disable_string: true,
			value_number: "",
			help: {
				description: tr("Id of parent element. If exists, filter elements that are direct children of that element."),
			}
		}) %>
...
<div class="tooltipinternal">
	<div class="tr tooltip-paragraph-first-fold">List of navigation elements within the system.</div>
</div>

<div class="container-fluid">
	<%= _.template($('#block_start').html())({
		...
		<%= _.template($('#input_constructor').html())({
			...
			description: tr("parent_category_id"),
			default_selector: "int",
			disable_string: true,
			value_number: "",
			help: {
				description: tr("Id of parent category. If exists, filter categories that are direct children of that category."),
			}
		}) %>
		<%= _.template($('#input_constructor').html())({
			id: "parent_forum_id",
			description: tr("parent_forum_id"),
			default_selector: "int",
			disable_string: true,
			value_number: "",
			help: {
				description: tr("Id of parent forum. If exists, filter categories that are direct children of that forum."),
			}
		}) %>
		<%= _.template($('#input_constructor').html())({
			id: "order",
			...
			disable_int: true,
			value_string: "",
			variants: ["natural","list"],
			help: {
				description: tr("Ordering of categories."),
			}
		}) %>
...
<div class="tooltipinternal">
	<div class="tr tooltip-paragraph-first-fold">List of all categories in the system.</div>
</div>

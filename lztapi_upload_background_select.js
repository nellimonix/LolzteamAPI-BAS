...
var background = GetInputConstructorValue('background', loader)
if (background['original'].length == 0) {
	Invalid(tr('The parameter "') + tr('background') + tr('" is not specified'))
	return
}

var x = GetInputConstructorValue('x', loader)
var y = GetInputConstructorValue('y', loader)
var crop = GetInputConstructorValue('crop', loader)
...
try {
	var code =
		...
		_.template($('#lztapi_upload_background_code').html())({

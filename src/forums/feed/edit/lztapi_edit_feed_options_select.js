...
var node_ids = GetInputConstructorValue('node_ids', loader)
var keywords = GetInputConstructorValue('keywords', loader)
...
try {
	var code =
		...
		_.template($('#lztapi_edit_feed_options_code').html())({
			node_ids: node_ids['updated'],

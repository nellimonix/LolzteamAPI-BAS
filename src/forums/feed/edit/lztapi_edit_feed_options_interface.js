<div class="container-fluid">
	...
	<%= _.template($('#input_constructor').html())({
		id: "node_ids",
		description: tr("node_ids"),
		default_selector: "string",
		disable_int: true,
		value_string: "",
		help: {
			description: tr("Array of forum ids to exclude from the feed.")
		}
	}) %>
	<%= _.template($('#input_constructor').html())({
		id: "keywords",
		description: tr("keywords"),
		default_selector: "string",
		disable_int: true,
		value_string: "",
		help: {
			description: tr("List of keywords to exclude specific threads from the feed.")
		}
	}) %>
...
<div class="tooltipinternal">
	<div class="tr tooltip-paragraph-first-fold">Edit feed options.</div>
</div>

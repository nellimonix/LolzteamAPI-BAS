var message_id = GetInputConstructorValue('message_id', loader)
if (message_id['original'].length == 0) {
	Invalid(tr('The parameter "') + tr('message_id') + tr('" is not specified'))
	return
}
...
try {
	var code =
		...
		_.template($('#lztapi_get_chat_report_reasons_code').html())({

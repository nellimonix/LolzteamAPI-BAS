<div class="container-fluid">
    <%= _.template($('#block_start').html())({
        ...
        <%= _.template($('#input_constructor').html())({
            id: "notification_id",
            description: tr("notification_id"),
            default_selector: "int",
            disable_string: true,
            value_number: "",
            help: {
                description: tr("If <code>notification_id</code> is omitted, it's mark all existing notifications as read.")
            }
        }) %>
...
<div class="tooltipinternal">
	<div class="tr tooltip-paragraph-first-fold">Mark single notification or all existing notifications read.</div>
</div>

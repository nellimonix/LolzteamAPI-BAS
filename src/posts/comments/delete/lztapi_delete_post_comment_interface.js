<div class="container-fluid">
	<%= _.template($('#input_constructor').html())({
		id: "post_comment_id",
		description: tr("post_comment_id"),
		default_selector: "int",
		disable_string: true,
		value_number: "",
		help: {
			description: tr("Id of post comment.")
		}
	}) %>
	...
	<%= _.template($('#input_constructor').html())({
		...
		value_string: "",
		help: {
			description: tr("Reason of a post comment removal.")
		}
	}) %>
...
<div class="tooltipinternal">
	<div class="tr tooltip-paragraph-first-fold">Delete a post comment.</div>
</div>

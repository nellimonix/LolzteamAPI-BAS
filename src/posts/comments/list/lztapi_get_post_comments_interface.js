<div class="container-fluid">
	...
	<%= _.template($('#block_start').html())({
		...
		<%= _.template($('#input_constructor').html())({
			...
			value_number: "",
			help: {
				description: tr("The time in milliseconds (e.g. 1652177794083) before last comment date.")
			}
		}) %>
		<%= _.template($('#input_constructor').html())({
			id: "before_comment",
			description: tr("before_comment"),
			default_selector: "int",
			disable_string: true,
			value_number: "",
			help: {
				description: tr("Comment id to get older comments.")
			}
		}) %>
...
<div class="tooltipinternal">
	<div class="tr tooltip-paragraph-first-fold">List of post comments in a thread.</div>
</div>

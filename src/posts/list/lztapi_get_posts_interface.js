<div class="container-fluid">
	<%= _.template($('#block_start').html())({
        ...
        <%= _.template($('#input_constructor').html())({
			id: "thread_id",
			description: tr("thread_id"),
			default_selector: "int",
			disable_string: true,
			value_number: "",
			help: {
				description: tr("Id of the containing thread."),
			}
		}) %>
		<%= _.template($('#input_constructor').html())({
			id: "page_of_post_id",
			description: tr("page_of_post_id"),
			default_selector: "int",
			disable_string: true,
			value_number: "",
			help: {
				description: tr("Id of a post, posts that are in the same page with the specified post will be returned. <code>thread_id</code> may be skipped."),
			}
		}) %>
		<%= _.template($('#input_constructor').html())({
			id: "page",
			...
			value_number: "",
			help: {
				description: tr("Page number of posts."),
			}
		}) %>
		<%= _.template($('#input_constructor').html())({
			id: "limit",
			...
			value_number: "",
			help: {
				description: tr("Number of posts in a page. Default value depends on the system configuration."),
			}
		}) %>
		<%= _.template($('#input_constructor').html())({
			id: "order",
			...
			disable_int: true,
			value_string: "",
			variants: ["natural","natural_reverse","post_likes","post_likes_reverse"],
			help: {
				description: tr("Ordering of posts."),
			}
		}) %>
...
<div class="tooltipinternal">
	<div class="tr tooltip-paragraph-first-fold">List of posts in a thread (with pagination).</div>
</div>

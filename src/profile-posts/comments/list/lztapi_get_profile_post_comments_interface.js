<div class="container-fluid">
	<%= _.template($('#input_constructor').html())({
		...
		value_number: "",
		help: {
			description: tr("Id of profile post.")
		}
	}) %>
	<%= _.template($('#block_start').html())({
		...
		<%= _.template($('#input_constructor').html())({
            ...
            value_number: "",
			help: {
				description: tr("Date to get older comments. Please note that this entry point does not support the page parameter but it still does support limit.")
			}
		}) %>
		<%= _.template($('#input_constructor').html())({
			id: "limit",
            ...
            value_number: "",
			help: {
				description: tr("Number of profile posts in a page.")
			}
		}) %>
...
<div class="tooltipinternal">
	<div class="tr tooltip-paragraph-first-fold">List of comments of a profile post.</div>
</div>

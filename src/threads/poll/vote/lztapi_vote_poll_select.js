...
var response_id = GetInputConstructorValue('response_id', loader)
var response_ids = GetInputConstructorValue('response_ids', loader)
...
try {
	var code =
		...
		_.template($('#lztapi_vote_poll_code').html())({
			threadId: threadId['updated'],
			response_id: response_id['updated'],
			response_ids: response_ids['updated'],

<div class="container-fluid">
	...
	<%= _.template($('#block_start').html())({
		...
		<%= _.template($('#checkbox').html())({
			id: "apply_thread_prefix",
			title: tr("Apply thread prefix"),
			checked: false
		}) %>
		<%= _.template($('#checkbox').html())({
			id: "send_alert",
			title: tr("Send a notification to users who are followed to target node"),
			checked: false
		}) %>
...
<div class="tooltipinternal">
	<div class="tr tooltip-paragraph-first-fold">Move a thread to another forum.</div>
</div>

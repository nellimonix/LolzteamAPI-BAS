<div class="container-fluid">
	...
	<%= _.template($('#input_constructor').html())({
		id: "node_id",
		description: tr("node_id"),
		default_selector: "int",
		disable_string: true,
		value_number: "",
		help: {
			description: tr("Filter by forum section.")
		}
	}) %>
	<%= _.template($('#input_constructor').html())({
		id: "like_type",
		description: tr("like_type"),
		default_selector: "string",
		disable_int: true,
		value_string: "",
		variants: ["like","like2"],
		help: {
			description: tr("Like type.")
		}
	}) %>
	<%= _.template($('#input_constructor').html())({
		id: "type",
		...
		disable_int: true,
		value_string: "",
		variants: ["gotten","given"],
		help: {
			description: tr("Likes type.")
		}
	}) %>
	<%= _.template($('#input_constructor').html())({
		id: "page",
		...
		value_number: "",
		help: {
			description: tr("Page number.")
		}
	}) %>
	<%= _.template($('#input_constructor').html())({
		id: "content_type",
		description: tr("content_type"),
		default_selector: "string",
		disable_int: true,
		value_string: "",
		variants: ["post","post_comment","profile_post","profile_post_comment"],
		help: {
	...
	<%= _.template($('#input_constructor').html())({
		id: "search_user_id",
		description: tr("search_user_id"),
		default_selector: "int",
		disable_string: true,
		value_number: "",
		help: {
			description: tr("Get only likes from specified user.")
		}
	}) %>
	<%= _.template($('#checkbox').html())({
		id: "stats",
		title: tr("Show weekly statistics."),
		checked: false
	}) %>
...
<div class="tooltipinternal">
	<div class="tr tooltip-paragraph-first-fold">Get user likes.</div>
</div>

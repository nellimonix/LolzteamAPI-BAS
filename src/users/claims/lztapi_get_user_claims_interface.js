<div class="container-fluid">
	...
	<%= _.template($('#input_constructor').html())({
		...
		disable_int: true,
		value_string: "",
		variants: ["market","nomarket"],
		help: {
			description: tr("Filter claims by their type.")
		}
	}) %>
	<%= _.template($('#input_constructor').html())({
		id: "claim_state",
		description: tr("claim_state"),
		default_selector: "string",
		disable_int: true,
		value_string: "",
		variants: ["active","solved","rejected","settled"],
		help: {
			description: tr("Filter claims by their state.")
		}
	}) %>
...
<div class="tooltipinternal">
	<div class="tr tooltip-paragraph-first-fold">Get user claims.</div>
</div>

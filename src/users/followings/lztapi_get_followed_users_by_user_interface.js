<div class="container-fluid">
	...
	<%= _.template($('#block_start').html())({
		...
		<%= _.template($('#input_constructor').html())({
			...
			disable_int: true,
			value_string: "",
            variants: ["natural","follow_date","follow_date_reverse"],
			help: {
				description: tr("Ordering of users.")
			}
		}) %>
        <%= _.template($('#input_constructor').html())({
            id: "page",
            ...
            value_number: "",
            help: {
                description: tr("Page number of users.")
            }
        }) %>
    	<%= _.template($('#input_constructor').html())({
            id: "limit",
            ...
            value_number: "",
            help: {
                description: tr("Number of users in a page.")
            }
        }) %>
...
<div class="tooltipinternal">
	<div class="tr tooltip-paragraph-first-fold">List of users whom are followed by a user.</div>
</div>

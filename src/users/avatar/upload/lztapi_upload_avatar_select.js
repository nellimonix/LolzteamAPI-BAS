...
var avatar = GetInputConstructorValue('avatar', loader)
if (avatar['original'].length == 0) {
	Invalid(tr('The parameter "') + tr('avatar') + tr('" is not specified'))
	return
}
...
try {
	var code =
		...
		_.template($('#lztapi_upload_avatar_code').html())({

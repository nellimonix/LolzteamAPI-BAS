<div class="container-fluid">
	...
	<%= _.template($('#checkbox').html())({
		id: "ignore_conversations",
		title: tr("Ignore user's conversations."),
		checked: false
	}) %>
	<%= _.template($('#checkbox').html())({
		id: "ignore_content",
		title: tr("Ignore user's content."),
		checked: false
	}) %>
	<%= _.template($('#checkbox').html())({
		id: "restrict_view_profile",
		title: tr("Restrict user from viewing your profile."),
		checked: false
	}) %>
...
<div class="tooltipinternal">
	<div class="tr tooltip-paragraph-first-fold">Edit ignoring options.</div>
</div>

<div class="container-fluid">
	<%= _.template($('#block_start').html())({
		...
		<%= _.template($('#input_constructor').html())({
			...
			value_string: "",
			help: {
				description: tr("Tag to search for tagged contents."),
			}
		}) %>
        <%= _.template($('#input_constructor').html())({
			id: "forum_id",
			...
			value_number: "",
			help: {
				description: tr("Id of the container forum to search for contents. Child forums of the specified forum will be included in the search."),
			}
		}) %>
        <%= _.template($('#input_constructor').html())({
			id: "user_id",
        ...
        <%= _.template($('#input_constructor').html())({
			...
			value_number: "",
			help: {
				description: tr("Number of thread data to be returned."),
			}
		}) %>
...
<div class="tooltipinternal">
	<div class="tr tooltip-paragraph-first-fold">Search for threads.</div>
</div>

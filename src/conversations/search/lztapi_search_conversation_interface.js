<div class="container-fluid">
	...
	<%= _.template($('#input_constructor').html())({
		...
		value_string: "",
		help: {
			description: tr("Search query string.")
		}
	}) %>
	<%= _.template($('#input_constructor').html())({
		id: "conversation_id",
	...
	<%= _.template($('#checkbox').html())({
		id: "search_recipients",
		title: tr("Search for recipients."),
		checked: false
	}) %>
...
<div class="tooltipinternal">
	<div class="tr tooltip-paragraph-first-fold">Search in conversations.</div>
</div>

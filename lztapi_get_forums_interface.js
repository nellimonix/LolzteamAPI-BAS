<div class="container-fluid">
	<%= _.template($('#block_start').html())({
		...
		<%= _.template($('#input_constructor').html())({
			...
			value_number: "",
			help: {
				description: tr("Id of parent category. If exists, filter forums that are direct children of that category."),
			}
		}) %>
		<%= _.template($('#input_constructor').html())({
			id: "parent_forum_id",
			...
			value_number: "",
			help: {
				description: tr("Id of parent forum. If exists, filter forums that are direct children of that forum."),
			}
		}) %>
		<%= _.template($('#input_constructor').html())({
			id: "order",
			...
			help: {
				description: tr("Ordering of forums."),
			}
		}) %>
...
<div class="tooltipinternal">
	<div class="tr tooltip-paragraph-first-fold">List of all forums in the system.</div>
</div>

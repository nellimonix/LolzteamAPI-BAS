<div class="container-fluid">
	<%= _.template($('#block_start').html())({
		...
		<%= _.template($('#input_constructor').html())({
			...
			value_number: "",
			help: {
				description: tr("Page number of conversations."),
			}
		}) %>
		<%= _.template($('#input_constructor').html())({
			id: "limit",
			...
			value_number: "",
			help: {
				description: tr("Number of conversations in a page."),
			}
		}) %>
...
<div class="tooltipinternal">
	<div class="tr tooltip-paragraph-first-fold">List of conversations (with pagination).</div>
</div>

<div class="container-fluid">
	...
	<%= _.template($('#block_start').html())({
		...
		<%= _.template($('#input_constructor').html())({
			...
			help: {
				description: tr("Ordering of followers.")
			}
		}) %>
        <%= _.template($('#input_constructor').html())({
            id: "page",
            ...
            value_number: "",
            help: {
                description: tr("Page number of followers.")
            }
        }) %>
    	<%= _.template($('#input_constructor').html())({
            id: "limit",
            ...
            value_number: "",
            help: {
                description: tr("Number of followers in a page.")
            }
        }) %>
...
<div class="tooltipinternal">
	<div class="tr tooltip-paragraph-first-fold">List of a user's followers.</div>
</div>

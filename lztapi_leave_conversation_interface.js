<div class="container-fluid">
	...
	<%= _.template($('#input_constructor').html())({
	id: "delete_type",
	description: tr("delete_type"),
	default_selector: "string",
	disable_int: true,
	value_string: "delete",
	variants: [
	"delete<br/><span style='color:rgb(43, 173, 114)'>" + tr("Accept future messages.<br/>") + "</span><span style='color:rgb(148, 148, 148)'>" + tr("Should this conversation receive further responses in the future, this conversation will be restored to your inbox.") + "</span>",
	"delete_ignore<br/><span style='color:rgb(43, 173, 114)'>" + tr("Ignore future messages.<br/>") + "</span><span style='color:rgb(148, 148, 148)'>" + tr("You will not be notified of any future responses and the conversation will remain deleted.") + "</span>",
	],
	help: {
	description: tr("Deletion type."),
}
}) %>
...
<div class="tooltipinternal">
	<div class="tr tooltip-paragraph-first-fold">Leave the conversation.</div>
</div>

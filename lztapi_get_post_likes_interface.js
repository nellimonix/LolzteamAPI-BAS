<div class="container-fluid">
	...
	<%= _.template($('#block_start').html())({
		...
		<%= _.template($('#input_constructor').html())({
			...
			value_number: "",
			help: {
				description: tr("Number of users in a page. Default value depends on the system configuration.")
			}
		}) %>
...
<div class="tooltipinternal">
	<div class="tr tooltip-paragraph-first-fold">List of users who liked a post.</div>
</div>

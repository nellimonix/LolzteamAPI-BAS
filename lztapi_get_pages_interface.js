<div class="container-fluid">
	<%= _.template($('#block_start').html())({
		...
		<%= _.template($('#input_constructor').html())({
			id: "parent_page_id",
			description: tr("parent_page_id"),
			default_selector: "int",
			disable_string: true,
			value_number: "",
			help: {
				description: tr("Id of parent page. If exists, filter pages that are direct children of that page."),
			}
		}) %>
		<%= _.template($('#input_constructor').html())({
			id: "order",
			...
			help: {
				description: tr("Ordering of pages."),
			}
		}) %>
...
<div class="tooltipinternal">
	<div class="tr tooltip-paragraph-first-fold">List of all pages in the system.</div>
</div>

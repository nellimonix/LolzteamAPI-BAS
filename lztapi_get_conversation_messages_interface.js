<div class="container-fluid">
    <%= _.template($('#input_constructor').html())({
        ...
        value_number: "",
        help: {
            description: tr("Id of needed conversation."),
        }
    }) %>
	<%= _.template($('#block_start').html())({
		...
		<%= _.template($('#input_constructor').html())({
			...
			value_number: "",
			help: {
				description: tr("Page number of messages."),
			}
		}) %>
		<%= _.template($('#input_constructor').html())({
			id: "limit",
			...
			value_number: "",
			help: {
				description: tr("Number of messages in a page."),
			}
		}) %>
		<%= _.template($('#input_constructor').html())({
			id: "order",
			...
			help: {
				description: tr("Ordering of messages."),
			}
		}) %>
        <%= _.template($('#input_constructor').html())({
			id: "before",
			description: tr("before"),
			default_selector: "int",
			disable_string: true,
			value_number: "",
			help: {
				description: tr("Date to get older messages."),
			}
		}) %>
		<%= _.template($('#input_constructor').html())({
			id: "after",
			...
			value_number: "",
			help: {
				description: tr("Date to get newer messages."),
			}
		}) %>
...
<div class="tooltipinternal">
	<div class="tr tooltip-paragraph-first-fold">List of messages in a conversation (with pagination).</div>
</div>

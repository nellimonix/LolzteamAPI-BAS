<div class="container-fluid">
	<%= _.template($('#input_constructor').html())({
		...
		textarea_height: 80,
		help: {
			description: tr("Content of the new post.")
		}
	}) %>
    <%= _.template($('#block_start').html())({
        ...
        <%= _.template($('#input_constructor').html())({
            ...
            value_number: "",
            help: {
                description: tr("Id of the target thread.")
            }
        }) %>
        <%= _.template($('#input_constructor').html())({
            id: "quote_post_id",
            description: tr("quote_post_id"),
            default_selector: "int",
            disable_string: true,
            value_number: "",
            help: {
                description: tr("Id of the quote post. It's possible to skip <code>thread_id</code> if this parameter is provided. An extra check is performed if both parameters exist and does not match.")
            }
        }) %>
...
<div class="tooltipinternal">
	<div class="tr tooltip-paragraph-first-fold">Create a new post.</div>
</div>

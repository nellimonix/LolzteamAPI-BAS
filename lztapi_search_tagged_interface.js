<div class="container-fluid">
	<%= _.template($('#block_start').html())({
        ...
        <%= _.template($('#input_constructor').html())({
			...
			value_string: "",
			help: {
				description: tr("List tags to search for tagged contents."),
                examples: [
                    {code: "steam"},
                    {code: "bas"},
                    {code: "bas,steam", description: tr("Specify multiple tags.") + " " +  tr("Must be separated by <code>,</code>.")}
                ]
			}
		}) %>
        <%= _.template($('#input_constructor').html())({
...
<div class="tooltipinternal">
	<div class="tr tooltip-paragraph-first-fold">Search for tagged contents.</div>
</div>

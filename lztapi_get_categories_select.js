var parent_category_id = GetInputConstructorValue('parent_category_id', loader)
var parent_forum_id = GetInputConstructorValue('parent_forum_id', loader)
...
try {
	var code =
		...
		_.template($('#lztapi_get_categories_code').html())({
			parent_category_id: parent_category_id['updated'],
			parent_forum_id: parent_forum_id['updated'],
			order: order['updated'],

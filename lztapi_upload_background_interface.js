<div class="container-fluid">
	...
	<%= _.template($('#input_constructor').html())({
		id: "background",
		description: tr("background"),
		default_selector: "string",
		disable_int: true,
		value_string: "",
		help: {
			description: tr("Base64 data of the background. Background image must be 1920x1080 pixels.")
		}
	}) %>
    <%= _.template($('#block_start').html())({
		...
		<%= _.template($('#input_constructor').html())({
			...
			value_number: "",
			help: {
				description: tr("The starting point of the selection by width."),
			}
		}) %>
        <%= _.template($('#input_constructor').html())({
			id: "y",
			...
			value_number: "",
			help: {
				description: tr("The starting point of the selection by height."),
			}
		}) %>
        <%= _.template($('#input_constructor').html())({
			id: "crop",
			...
			value_number: "",
			help: {
				description: tr("Selection size. Minimum value - 100."),
			}
		}) %>
...
<div class="tooltipinternal">
	<div class="tr tooltip-paragraph-first-fold">Upload background for a user.</div>
</div>

<div class="container-fluid">
	<%= _.template($('#input_constructor').html())({
		id: "notificationId",
		description: tr("notificationId"),
		default_selector: "int",
		disable_string: true,
		value_number: "",
		help: {
			description: tr("Id of notification."),
		}
	}) %>
...
<div class="tooltipinternal">
	<div class="tr tooltip-paragraph-first-fold">Get associated content of notification. The response depends on the content type.</div>
</div>

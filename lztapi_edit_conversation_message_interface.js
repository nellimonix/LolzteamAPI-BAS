<div class="container-fluid">
	<%= _.template($('#input_constructor').html())({
		id: "messageId",
		description: tr("messageId"),
		default_selector: "int",
		disable_string: true,
		value_number: "",
		help: {
			description: tr("Id of message.")
		}
	}) %>
    <%= _.template($('#input_constructor').html())({
		id: "message_body",
		...
		textarea_height: 80,
		help: {
			description: tr("New content of the message.")
		}
	}) %>
...
<div class="tooltipinternal">
	<div class="tr tooltip-paragraph-first-fold">Edit a message.</div>
</div>

...
<div class="tooltipinternal">
	<div class="tr tooltip-paragraph-first-fold">List of a forum's followers. For privacy reason, only the current user will be included in the list (if the user follows the specified forum).</div>
</div>
